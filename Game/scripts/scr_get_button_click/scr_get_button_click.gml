////@desc scr_get_button_click(x, y, width, height, h_reference, v_reference)
///@arg0 x
///@arg1 y
///@arg2 width
///@arg3 height
...
if left_ <= mouse_pos_[0] and mouse_pos_[0] <= right_ and top_ <= mouse_pos_[1] and mouse_pos_[1] <= bot_ and mouse_check_button_pressed(mb_left) {
	return true;
} else {
	return false;
}